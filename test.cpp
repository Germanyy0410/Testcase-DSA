...
int main() {
    ...
    for (int i = 0; i < 1500; i++){
        ...
        string expect = "D:\\Testcase\\Testcase Demo\\output\\expected" + to_string(i+1) + ".txt";       //<-------- Throw your output folder path here and add additional \ in your path. Then add \\expected. In general, your path will look similar mine.
